...
public class YGoodsDetailsBean {
    /**
     * id : 56
    ...
    private List<YGoodsDetailsBean.SkuStockListBean> skuStockList;
    private List productAttributeValueList;
    private List<YGoodsDetailsBean.XsProductAttributesBean> xsProductAttributes;
    ...
    public List<YGoodsDetailsBean.SkuStockListBean> getSkuStockList() {
        return skuStockList;
    }

    public void setSkuStockList(List<YGoodsDetailsBean.SkuStockListBean> skuStockList) {
    ...
    public List<YGoodsDetailsBean.XsProductAttributesBean> getXsProductAttributes() {
        return xsProductAttributes;
    }

    public void setXsProductAttributes(List<YGoodsDetailsBean.XsProductAttributesBean> xsProductAttributes) {
        this.xsProductAttributes = xsProductAttributes;
    }

    @Override
    public String toString() {
        return "YGoodsDetailsBean{" +
                "id=" + id +

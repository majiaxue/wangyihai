...
public class YMineBean {
    ...
    public String getWeixinPaymentCode() {
        return weixinPaymentCode;
    }

    public void setWeixinPaymentCode(String weixinPaymentCode) {
        this.weixinPaymentCode = weixinPaymentCode;
    }

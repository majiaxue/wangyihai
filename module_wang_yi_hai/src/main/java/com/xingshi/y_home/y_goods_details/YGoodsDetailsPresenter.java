...
public class YGoodsDetailsPresenter extends BasePresenter<YGoodsDetailsView> {


    private YGoodsDetailsBean yGoodsDetailsBean;
    private List<YGoodsDetailsBean.SkuStockListBean> dataList = new ArrayList<>();
    //流式布局--颜色
    ...
    public YGoodsDetailsPresenter(Context context) {
        super(context);
    }
    ...
    public void initData(int id) {
        ...
        Observable<ResponseBody> observable = RetrofitUtil.getInstance().getApi(CommonResource.BASEURL_9001).getHeadWithout(CommonResource.GETGOODSDETAIL + "/" + id + "/1", SPUtil.getToken());
        RetrofitUtil.getInstance().toSubscribe(observable, new OnMyCallBack(new OnDataListener() {
            @Override
            public void onSuccess(String result, String msg) {
                LogUtil.e("商品详情：" + result);
                yGoodsDetailsBean = JSON.parseObject(result, YGoodsDetailsBean.class);
                dataList = yGoodsDetailsBean.getSkuStockList();
...
//                    String[] split = yGoodsDetailsBean.getXsProductAttributes().get(1).getInputList().split(",");
...
//                    String[] split = yGoodsDetailsBean.getXsProductAttributes().get(2).getInputList().split(",");
//                    for (int i = 0; i < split.length; i++) {
...
//                    getView().loadImage(goodsImageAdapter);
                    getView().loadUI(yGoodsDetailsBean, sp1List.size());
                }

                //轮播图
                String albumPics = yGoodsDetailsBean.getAlbumPics();
            ...
            public void onError(String errorCode, String errorMsg) {
                LogUtil.e("商品详情：errorMsg" + errorMsg);
    ...
    public void completeTask(){
        Observable<ResponseBody> headWithout = RetrofitUtil.getInstance().getApi(CommonResource.BASEURL_9006).getHeadWithout(CommonResource.COMPLETETASK, SPUtil.getToken());
    ...
    public void chooseGoodsPop() {
        try {
            if (yGoodsDetailsBean != null && yGoodsDetailsBean.getXsProductAttributes().size() > 0 && dataList.size() > 0) {
                View view = LayoutInflater.from(mContext).inflate(R.layout.pop_y_choose_goods, null);
                final ImageView img = view.findViewById(R.id.pop_y_choose_goods_img);
                final TextView price = view.findViewById(R.id.pop_y_choose_goods_price);
                final TextView type = view.findViewById(R.id.pop_y_choose_goods_type);
                ImageView cancel = view.findViewById(R.id.pop_y_choose_goods_cancel);
                flow1 = view.findViewById(R.id.pop_y_choose_goods_flow1);
                flow2 = view.findViewById(R.id.pop_y_choose_goods_flow2);
                flow3 = view.findViewById(R.id.pop_y_choose_goods_flow3);
                TextView minus = view.findViewById(R.id.pop_y_choose_goods_minus);
                TextView add = view.findViewById(R.id.pop_y_choose_goods_add);
                final TextView count = view.findViewById(R.id.pop_y_choose_goods_count);
                TextView buy = view.findViewById(R.id.pop_y_choose_goods_buy);
                TextView title1 = view.findViewById(R.id.pop_y_choose_goods_title1);
                TextView title2 = view.findViewById(R.id.pop_y_choose_goods_title2);
                TextView title3 = view.findViewById(R.id.pop_y_choose_goods_title3);
//            RecyclerView rv = view.findViewById(R.id.pop_y_choose_goods_rv);
                ...
                if (attrSize == 1) {
                    ...
                    title1.setText(yGoodsDetailsBean.getXsProductAttributes().get(0).getName());
                } else if (attrSize == 2) {
                    title3.setVisibility(View.GONE);
                    flow3.setVisibility(View.GONE);
                    title2.setText(yGoodsDetailsBean.getXsProductAttributes().get(1).getName());
                    title1.setText(yGoodsDetailsBean.getXsProductAttributes().get(0).getName());
                } else {
                    title1.setText(yGoodsDetailsBean.getXsProductAttributes().get(0).getName());
                    title2.setText(yGoodsDetailsBean.getXsProductAttributes().get(1).getName());
                    title3.setText(yGoodsDetailsBean.getXsProductAttributes().get(2).getName());
                }
                ...
                for (int i = 0; i < attrSize; i++) {
                    sb.append(yGoodsDetailsBean.getXsProductAttributes().get(i).getName() + "  ");
                }
                type.setText(sb);
                ...
                if (isChoose) {
                    ...
                    Glide.with(mContext).load(yGoodsDetailsBean.getPic()).into(img);
                }

                img.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        PopUtils.seeBigImg(mContext, sp1Position == -1 ? yGoodsDetailsBean.getPic() : sp1List.get(sp1Position).getPicUrl());
                    }
                });

                YPopUtil.setTransparency(mContext, 0.3f);
                popupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() {
                    @Override
                    public void onDismiss() {
                        YPopUtil.setTransparency(mContext, 1f);
                        if (attrSize == 1) {
                            if (sp1Position == -1) {
    ...
    private YGoodsDetailsBean.SkuStockListBean stock1(String str, int position) {
        List<YGoodsDetailsBean.SkuStockListBean> list = new ArrayList<>();
        if (str != null) {
            for (int i = 0; i < dataList.size(); i++) {
            ...
            return new YGoodsDetailsBean.SkuStockListBean();
        }
    }

    private YGoodsDetailsBean.SkuStockListBean stock12(String str, String str2, int position) {
        List<YGoodsDetailsBean.SkuStockListBean> list = new ArrayList<>();
    ...
    private YGoodsDetailsBean.SkuStockListBean stock13(String str, String str3, int position) {
        List<YGoodsDetailsBean.SkuStockListBean> list = new ArrayList<>();
    ...
    private YGoodsDetailsBean.SkuStockListBean stock23(String str3, String str2, int position) {
        List<YGoodsDetailsBean.SkuStockListBean> list = new ArrayList<>();
    ...
    public void chooseOrJump() {
        if (SPUtil.getToken() == null || "".equals(SPUtil.getToken())) {
            ...
            if (isChoose) {
                ...
                if (attrSize == 1) {
                    orderConfirmBean.setSellerId(yGoodsDetailsBean.getSellerId() + "");
                    orderConfirmBean.setSellerName(yGoodsDetailsBean.getSellerName());
                    ...
                    orderConfirmBean.setPic(yGoodsDetailsBean.getPic());
                    orderConfirmBean.setProductName(yGoodsDetailsBean.getName());
                    orderConfirmBean.setFeightTemplateId((long) yGoodsDetailsBean.getFeightTemplateId());
                    orderConfirmBean.setStock(dataList.get(sp1Position).getStock());
                    orderConfirmBean.setProductId(yGoodsDetailsBean.getId() + "");
                    orderConfirmBean.setProductCategoryId(yGoodsDetailsBean.getProductCategoryId() + "");
                    orderConfirmBean.setProductPrice(yGoodsDetailsBean.getOriginalPrice());
                    orderConfirmBean.setProductSn(yGoodsDetailsBean.getProductSn());
                    orderConfirmBean.setPromotionPrice(sp1List.get(sp1Position).getPrice());
                    orderConfirmBean.setProductAttr(yGoodsDetailsBean.getXsProductAttributes().get(0).getName() + ":" + sp1List.get(sp1Position).getContent());
                    ...
                    orderConfirmBean.setProductPrice(yGoodsDetailsBean.getOriginalPrice());
                    orderConfirmBean.setProductSn(yGoodsDetailsBean.getProductSn());
                    orderConfirmBean.setPromotionPrice(stock1(sp1List.get(sp1Position).getContent(), sp2Position).getPromotionPrice());
                    orderConfirmBean.setProductAttr(yGoodsDetailsBean.getXsProductAttributes().get(0).getName() + "：" + sp1List.get(sp1Position).getContent() + "、" + yGoodsDetailsBean.getXsProductAttributes().get(1).getName() + "：" + sp2List.get(sp2Position).getContent());
                    ...
                    orderConfirmBean.setProductPrice(yGoodsDetailsBean.getOriginalPrice());
                    orderConfirmBean.setProductSn(yGoodsDetailsBean.getProductSn());
                    orderConfirmBean.setPromotionPrice(stock12(sp1List.get(sp1Position).getContent(), sp2List.get(sp2Position).getContent(), sp3Position).getPromotionPrice());
                    orderConfirmBean.setProductAttr(yGoodsDetailsBean.getXsProductAttributes().get(0).getName() + "：" + sp1List.get(sp1Position).getContent() + "、" + yGoodsDetailsBean.getXsProductAttributes().get(1).getName() + "：" + sp2List.get(sp2Position).getContent() + "、" + yGoodsDetailsBean.getXsProductAttributes().get(2).getName() + ":" + sp3List.get(sp3Position).getContent());

                }

                Intent intent = new Intent(mContext, YConfirmOrderActivity.class);

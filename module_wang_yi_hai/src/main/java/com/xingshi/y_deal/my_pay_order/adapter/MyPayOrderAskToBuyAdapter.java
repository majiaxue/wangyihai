...
public class MyPayOrderAskToBuyAdapter extends MyRecyclerAdapter<MyPayOrderAskToBuyBean.RecordsBean> {

    public MyPayOrderAskToBuyAdapter(Context context, List<MyPayOrderAskToBuyBean.RecordsBean> mList, int mLayoutId) {
    ...
    public void convert(RecyclerViewHolder holder, MyPayOrderAskToBuyBean.RecordsBean data, int position) {
        ...
        holder.setImageFresco(R.id.my_pay_order_rec_image, data.getIcon() == null ? "" : data.getIcon())
                .setText(R.id.my_pay_order_rec_type_name, "买单")

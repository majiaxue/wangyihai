...
public class MyPayOrderAppealListAdapter extends MyRecyclerAdapter<AppealListBean.RecordsBean> {

    public MyPayOrderAppealListAdapter(Context context, List<AppealListBean.RecordsBean> mList, int mLayoutId) {

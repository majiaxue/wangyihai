...
public class MinePresenter extends BasePresenter<MineView> {
    ...
    public void loadData() {
        ...
        RetrofitUtil.getInstance().toSubscribe(observable, new OnMyCallBack(new OnDataListener() {
            ...
            public void onSuccess(String result, String msg) {
                ...
                File file = new File(Environment.getExternalStorageDirectory().getPath() + "/wyh/image/" + "wyhHead.jpg");
                if (file.exists()) {
    ...
    private void downPic(String url) {
        ...
        File file = new File(Environment.getExternalStorageDirectory() + "/wyh/image");
        if (file.exists()) {
            file.mkdirs();
        }
        File file1 = new File(Environment.getExternalStorageDirectory() + "/wyh/image/" + "wyhHead.jpg");
        try {
            //文件输出流

...
######################webview###################
-keepclassmembers class com.xingshi.utils.AndroidJs {
   public *;
}
...
-keep class com.xingshi.common.**{*;}
-keep class com.xingshi.net.**{*;}
-keep class com.xingshi.bean.**{*;}
-keep class com.xingshi.dbflow**{*;}
...
-dontwarn com.kakao.**
-keep public class com.umeng.com.umeng.soxingshi.R$*{

            ...
            public void onSuccess(String result, String msg) {
                ...
                try {
                    ...
                    if (sellerAdapter == null) {
                        sellerAdapter = new LocalSellerAdapter(mContext, shopBeans, com.xingshi.user_store.R.layout.rv_local_seller);
        ...
        RetrofitUtil.getInstance().toSubscribe(observable, new OnMyCallBack(new OnDataListener() {
            ...
            public void onSuccess(String result, String msg) {
                ...
                if (result != null) {
                    ...
                    navbarAdapter = new LocalNavbarAdapter(mContext, navbarList, com.xingshi.user_store.R.layout.rv_local_navbar);
                    if (getView() != null) {

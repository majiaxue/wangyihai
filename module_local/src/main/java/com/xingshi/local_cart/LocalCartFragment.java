...
public class LocalCartFragment extends BaseFragment<LocalCartView, LocalCartPresenter> implements LocalCartView {
    ...
    public void deleteSuccess() {
        ...
        localCartHide.setVisibility(View.VISIBLE);
        compileStatus = true;
        localCartCheckAll.setImageResource(com.xingshi.user_store.R.drawable.icon_weixuanzhong);
    }
    ...
    public void isCheckAll(boolean isCheckAll) {
        if (isCheckAll) {
            localCartCheckAll.setImageResource(com.xingshi.user_store.R.drawable.icon_xuanzhong);
        } else {
            localCartCheckAll.setImageResource(com.xingshi.user_store.R.drawable.icon_weixuanzhong);
        }
    }

...
import com.xingshi.utils.OnCountChangeListener;
import com.xingshi.utils.OnSelectViewListener;
...
//                updateIsAll();
                        ...
                        if (dataBeanList.size() == 0) {
                            ...
                            if (cartParentRecAdapter == null) {
                                cartParentRecAdapter = new CartParentRecAdapter(mContext, dataBeanList, com.xingshi.user_store.R.layout.item_cart_parent, new OnSelectViewListener() {
                                    @Override
    ...
    public void popupDelete() {
        View view = LayoutInflater.from(mContext).inflate(com.xingshi.user_store.R.layout.popup_delete, null, false);
        TextView confirm = view.findViewById(com.xingshi.user_store.R.id.popup_delete_confirm);
        TextView cancel = view.findViewById(com.xingshi.user_store.R.id.popup_delete_cancel);

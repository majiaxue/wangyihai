...
import com.xingshi.local_store.ShoppingRight.RvListener;
import com.xingshi.local_store.ShoppingRight.ShopOnClickListtener;
            ...
            switch (itemViewType) {
                ...
                case 1:
                    ...
                    add.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            View inflate = LayoutInflater.from(mContext).inflate(com.xingshi.module_base.R.layout.pop_choose_specs, null);
                            ImageView img = inflate.findViewById(com.xingshi.module_base.R.id.pop_choose_specs_img);
                            final ImageView cancel = inflate.findViewById(com.xingshi.module_base.R.id.pop_choose_specs_cancel);
                            TextView name = inflate.findViewById(com.xingshi.module_base.R.id.pop_choose_specs_name);
                            final TextView price = inflate.findViewById(com.xingshi.module_base.R.id.pop_choose_specs_price);
                            final TextView btn = inflate.findViewById(com.xingshi.module_base.R.id.pop_choose_specs_btn);
                            RecyclerView rv = inflate.findViewById(com.xingshi.module_base.R.id.pop_choose_specs_rv);
                            //选中商品的价格

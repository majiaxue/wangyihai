...
public class ForgetPresneter extends BasePresenter<ForgetView> {
    ...
    public void commit(String phone, String code, String password, String confirmPassword) {
        if ("".equals(phone) || "".equals(code) || "".equals(password) || "".equals(confirmPassword)) {
            Toast.makeText(mContext, mContext.getResources().getString(com.xingshi.module_base.R.string.please_input_more_info), Toast.LENGTH_SHORT).show();
        } else if (!password.equals(confirmPassword)) {
            Toast.makeText(mContext, mContext.getResources().getString(com.xingshi.module_base.R.string.password_no_same), Toast.LENGTH_SHORT).show();
